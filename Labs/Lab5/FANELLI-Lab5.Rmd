...
___The cases in this dataset are individual births.___

___Number of Cases:___
...
```{r}
boxplot(nc[,c("habit","weight")], main="Habit and Weight", xlab="Weight", ylab="Habit")
```

___This boxplot highlights the fact that they are different data types: numeric and categorical.___
...
___The Conditions are met: 873 non smokers, 126 smokers.  The 2 are not directly related___

4.  Write the hypotheses for testing if the average weights of babies born to 
smoking and non-smoking mothers are different.

___H0:___  The average weight of babies born to smokers and non-smokers are equal

___H1:___  The average weight of babies born to smokers and non-smokers are NOT equal
