...
```{r find-trend-in-number-of-girls, eval=TRUE}
plot(x = arbuthnot$year, y = arbuthnot$girls, type = "l")
title(main = "Aside from about 1640 to 1660, the general trend has been increasing")
```
...
# WHAT I SEE IS THAT, THOUGH NOT MUCH MORE THAN 50%, THERE'S ALWAYS MORE BOYS BORN THAN GIRLS FROM AS FAR BACK AS 1640
plot(x = arbuthnot$year, y = (arbuthnot$boys/(arbuthnot$boys+arbuthnot$girls)), type = "l", ylim=c(0.0,1.0))
title(main = "% of Boys by year")
