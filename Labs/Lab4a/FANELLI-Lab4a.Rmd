...
1.  __Describe this population distribution:__
    This population distribution has a min of 334, a median of 1442, and a max of 3642.  Its mean is 1500.  It's first and 3rd quartile values are 1126 and 1743, repectively.

    In Table Format:
  
    __Min. 1st Qu.  Median    Mean 3rd Qu.    Max.__
...
2.  __Describe the distribution of this sample. How does it compare to the 
    distribution of the population?__
    
    Row 1: First Dist, Row 2: Second Dist
    
    __Min. 1st Qu.  Median    Mean 3rd Qu.    Max.__
    
    334    1126    1442    1500    1743    5642 
    
    520    1200    1544    1559    1775    3005 
    
    The 2nd distribution seems to have a smaller base/range and everything else larger (1st Qu.  Median    Mean 3rd Qu.)
...
3.  __Take a second sample, also of size 50, and call it `samp2`.  How does the 
    ...
    would provide a more accurate estimate of the population mean?__
    
    Samp1 mean was 1559, samp2 mean was 1477.5  If I took 2 more samples, 1 of size 100 and the other of size 1000, I'd expect the larger (size 1000) to be a more accurate estimate of the population mean.
...
4.  __How many elements are there in sample-means50?  Describe the sampling 
    ...
    There are 5000 elements in sample_means50 (...ran: length(sample_means50)). sample_means50's summary stats are:
    
    __Min. 1st Qu.  Median    Mean 3rd Qu.    Max.__
    
    1233    1452    1497    1499    1545    1786
    
    Recall that the 1st and 2nd distributions from above were:
...
Each element represents a sample set that just got calculated.
...
When the sample size is larger, the center gets higher, or more frequent.  The spreads gets less spread out.
